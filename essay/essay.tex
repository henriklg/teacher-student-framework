...
My hope is that by implementing an object-tracing algorithm I can use it to classify irregularities in the colonoscopy video, and then track that object in the later frames until it disappear out of frame. This will help with reducing the stability of the network so that the classifier don't have to check every frame. 
