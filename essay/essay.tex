...
\begin{figure}
  \begin{center}
    \includegraphics[width=\textwidth]{fibre-optic-endoscopy}
...
To detect irregularities in the digestive system is a difficult task and time-consuming. To classify irregularities correctly and precisely require expert knowledge. Furtunately we have access to data which already has been labeled by trained proffesionals that we will use in this project. However I feel that some very basic knowledge will come in handy. \footnote{some text}
