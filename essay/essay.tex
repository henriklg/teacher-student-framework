...
I am excited to begin working on this project and I feel very much motivated for doing further research and to implement some of the papers I have read during writing this paper. I have found several papers which I unfortunately did not have time to look at but the amount of work done in this field will be of much use. Especially excited to implement and perhaps improve on the work done by \citeauthor*{LesionDetection15} and \citeauthor*{DeepLearning17}. And if possible, be able to use the work done by \citeauthor*{DeepEndoVO18} to track the capsule throughout the intestine. Which hopefully will be a useful tool for doctors and specialists looking at WCE video in the future. However I expect to meet some difficulties along the way. Example, I read that group behind the Deep EndoVO paper used a camera capsule with a fairly high refresh rate. Having fewer datapoints per distance traveled will increase the likelihood of drifting away from the ground truth. 

I have included a section about segmentation but I do not plan on getting into that unless I get a lot of spare time at the end of writing my thesis. The main objective of my thesis will be to label the video with regions of interest for the doctors to have a closer look at. 
