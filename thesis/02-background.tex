...
%TODO use same figures as Steven? or have Petra make one
...
%TODO : fit table to linewidth. remove procedure names?
...
% mention pre-trained models etc
% ----------------------------------------------------------
...
% ----------------------------------------------------------
\section{Available datasets} \label{sec:available_datasets}
% ----------------------------------------------------------
...
%TODO : add sources to dataset papers
\begin{table}[h!]
  \scriptsize
  \centering
  \begin{tabular}{|p{.15\textwidth}|p{.11\textwidth}|p{.1\textwidth}|p{.16\textwidth}|p{.1\textwidth}|p{.2\textwidth}|}
  	\hline
  	\textbf{Dataset Name}	&\textbf{Data Source}	&\textbf{Findings}	&\textbf{Size}	&\textbf{Status}		&\textbf{Description} \\
    \hline
    CVC-ClinicDB	&Colonoscopy	&Polyps		&612 still images from 29 different sequences with polyp mask	&Available	&From 29 different sequences with
polyp mask (ground truth) \\ 
    \hline
    ASU-Mayo Clinic Colonoscopy Video DB	&Colonoscopy	&Polyps	&20 videos for training and 18 for testing	&Copyrighted	&10 videos with polyp detection,
10 videos without polyps, GT available \\
	\hline
	CVC colon DB	&Colonoscopy	&Polyps	&300 frames with ROI	&By explicit permission	&15 short colonoscopy sequences
(different studies) \\
	\hline
	ETIS-Larib Polyp DB	&Colonoscopy	&Polyps	&196 images	&By request	&196 images with GT \\
	\hline
	GI Lesions in Regular Colonoscopy Data Set	&Colonoscopy	&GI lesions	&76 instances	&Available	&15 serrated adenomas, 21 hyperplastic lesions, 40 adenomas \\
	\hline
	GastroAtlas	&Endoscopy	&GI lesions	&5,029 video clips	&Available	&Low-quality videos \\
	\hline
	The Atlas of Gastrointestinal Endoscopy	&Endoscopy	&GI lesions	&1295 images	&Available	&Esophagus, Stomach, Duodenum and Ampulla, Capsule Endoscopy, Inflammatory Bowel Disease, Colon and Ileum and some Miscellaneous \\
	\hline
	WEO Clinical Endoscopy Atlas	&Endoscopy	&GI lesions	&152 images	&By explicit permission	&One image per lesion \\
	\hline
	GASTROLAB	&Endoscopy	&GI lesions	&Several hundreds of images and several tenths of videos	&Discontinued	&Partially damaged dataset \\
	\hline
	KID	&VCE	&GI lesions	&2,448 images and three videos	&Discontinued, by request	&Dataset access issues \\
	\hline
	Kvasir-V2	&Various	&GI lesions \& landmarks	&8,000 images, 8 classes, 1,000 images per class	&Available, public, free for research and educational purposes	&See section 3.1 for the description \\
	\hline
	Hyper-Kvasir &Endoscopy	&Gi lesions and landmarks	&XXX labeled images, XXX videos and XXX unlabeled images	&Available, public, free for research and educational purposes	&See section X \\
	\hline
	Nerthus	&Colonoscopy	&GI findings	&5,525 frames extracted from the 21 videos, 4 classes, from 500 to 2,700 frames per class	&Available, public, free for research and educational purposes	&XXX \\
	\hline
	Medico	&Various	&GI lesions, landmarks and findings	&14,033 images, 16 classes, from 4 to 2,331 images per class	&Available, public, free for research and educational purposes	&XXX \\
	\hline
	Kvasir-Pillcam	&WCE	&GI lesions, landmarks and findings	&XXX images with ROI, XX classes and XXX unlabeled images/videos	&Available, public, free for research and educational purposes& See section X \\
	\hline
  \end{tabular}
  \caption{Existing endoscopic image and video datasets.}
