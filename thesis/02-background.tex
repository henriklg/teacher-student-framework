...
\begin{figure} % fibre-optic-endoscope
  \begin{center}
    ...
    \caption[Image of a fibre optic endoscope with explanation of different parts of the tool]{Image of a fibre optic endoscope with explanation of different parts of the tool\footnotemark.}
