...
% Screenig
At the current state screening is too expensive for the medical sector. This could be improved by the use of cheaper screening methods like VCE and Artificial Intelligence (A.I).
