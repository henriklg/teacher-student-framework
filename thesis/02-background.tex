...
%TODO use same figures as Steven?
...
% ----------------------------------------------------------
The GI tract may be home to a multitude of diseases. %name some and end with CRC


Given the severity of colorectal cancer we have dedicated this section to give some further insight into this particular disease. %might mention some other diseases?

%TODO add image of polyp etc? or a graph of death rate?
...
% ----------------------------------------------------------
%Source1: https://www.nhs.uk/conditions/endoscopy/
%TODO : find a new beginning of section
%TODO : add reference to endoscopy_types table
